...
public class StudentDataBase {
    ...
    public static List<Student> getAllStudents() {
        ...
        student2.setBike(Optional.of(new Bike("Giant", "Contend AR 4")));
        student4.setBike(Optional.of(new Bike("Trek", "Marlin 8")));
        student5.setBike(Optional.of(new Bike("Specialized", "Rockhopper Comp")));
